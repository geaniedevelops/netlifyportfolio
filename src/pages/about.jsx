  ...
  return (
    <AppTemplate pageName="about">
      <section className="about__blurb">
        <h1>About</h1>
        <p>
          Gouda stinking bishop queso. Caerphilly stinking bishop say cheese
          when the cheese comes out everybody's happy manchego fromage the big
          cheese bocconcini. Taleggio cauliflower cheese swiss squirty cheese
          cream cheese bavarian bergkase lancashire stinking bishop. St. agur
          blue cheese queso who moved my cheese chalk and cheese st. agur blue
          cheese swiss paneer stinking bishop. Taleggio cheese triangles cheesy
          feet pepper jack.
        </p>
      </section>
